#!/bin/env python3
# Exporta origem e destino por data, horário, modo e commuting (bool.) (pivotada)
    ...
    for ftriptype in ["microtrip","bus","private_transport"] :        
        for fcommuting in ["true","false"] :
            for ftimeorigin in ["0000_0059","0100_0159","0200_0259","0300_0359","0400_0459","0500_0559","0600_0659","0700_0759","0800_0859","0900_0959","1000_1059","1100_1159","1200_1259","1300_1359","1400_1459","1500_1559","1600_1659","1700_1759","1800_1859","1900_1959","2000_2059","2100_2159","2200_2259","2300_2359"] :
                request = "/generatematrix?format=json&project={}&date={}&ftriptype={}&ftimeorigin={}&fcommuting={}".format(projectID, date, ftriptype, ftimeorigin, fcommuting)
...
final_data =  pd.pivot_table(data, index=['ProjectID', 'Date', 'Origin', 'Destination', 'Modo', 'Commuting'], columns='TimeOrigin', values='Trips')
final_data.to_csv("matriz2b.csv")